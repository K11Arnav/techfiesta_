...
export default function FeatureSpaceGraph() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <section className="mt-12 bg-zinc-900/60 border border-zinc-800 rounded-2xl p-6 overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="relative overflow-hidden">
            ...
            {selectedPoint && (
              <div className="absolute top-4 right-4 w-64 max-w-[40%] bg-zinc-900/95 border border-zinc-800 rounded-xl p-4 shadow-2xl backdrop-blur-md animate-in fade-in slide-in-from-right-4 overflow-hidden">
